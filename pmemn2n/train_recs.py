...
tf.flags.DEFINE_integer("task_id", 1, "bAbI task id, 0 : QA, 1 : RECS")
tf.flags.DEFINE_integer("random_state", None, "Random state.")
tf.flags.DEFINE_string("data_dir", "../data/movie_recs_index.txt", "Directory containing bAbI tasks")
FLAGS = tf.flags.FLAGS

print("Started Task:", FLAGS.task_id)

# task data
train, test = load_recs_task(FLAGS.data_dir, FLAGS.task_id)
data = train + test
